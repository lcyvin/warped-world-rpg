...
<p>
Ever-constant rain lightly taps against the window of a dimly-lit studio in some back
corner of the city. Against the far wall, a figure sits hunched over a twisted heap of 
metal. Sparks fly from a welding torch they hold, the room illuminating as though the 
storm’s lightning has been brought within its walls.
</p>
<p>
...
scowl. Grabbing a backpack from the foot of a nearby bed, they race for the back door. 
There’s one group no Anartist wants to deal with, and they’re currently banging at the door. 
</p>
</blockquote>
...
This book is provided for free, forever, online at [warpedworldrpg.com](https://warpedworldrpg.com).
The source for this book is open to collaboration and can be found at [github.com/lcyvin/warped-world-rpg](https://github.com/lcyvin/warped-world-rpg).
Guidelines for contribution may be reviewed in the [contributing](/errata/contributing/intro.md) section of this book.

## Content Warning

This book contains themes relating to distortion of reality, general horror, and mental 
manipulation. This book contains reference to and discussion of combat and conflict,
firearms and other weaponry in the context of game mechanics. Additionally, this book contains 
...
[github.com/lcyvin/warped-world-rpg/blob/main/LICENSE](https://github.com/lcyvin/warped-world-rpg/blob/main/LICENSE).
